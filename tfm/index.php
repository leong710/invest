...
$CONFIG = '{"lang":"zh-TW","error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"dark"}';
...
$root_path = $_SERVER['DOCUMENT_ROOT'].'/invest/doc_pdf';

// Root url for links in file manager.Relative to $http_host. Variants: '', 'path/to/subfolder'
// Will not working if $root_path will be outside of server document root
$root_url = '/invest/tfm/share';
