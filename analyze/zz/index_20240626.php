    ...
    <div class="col-12">
        <div class="row justify-content-center">
            <div class="col_xl_11 col-12 rounded" style="background-color: rgba(255, 255, 255, .8);">
                ...
                <div class="row">
                    <nav>
                        <div class="nav nav-tabs pt-3 pb-0" id="nav-tab" role="tablist">
                            <button id="nav-tab_1" data-bs-toggle="tab" data-bs-target="#tab_1" type="button" role="tab" aria-controls="tab_1" aria-selected="true" class="nav-link active">案件統計</button>
                            <button id="nav-tab_2" data-bs-toggle="tab" data-bs-target="#tab_2" type="button" role="tab" aria-controls="tab_2" aria-selected="false" class="nav-link">訪談內容統計</button>
                            <button id="nav-tab_3" data-bs-toggle="tab" data-bs-target="#tab_3" type="button" role="tab" aria-controls="tab_3" aria-selected="false" class="nav-link">3.</button>
                        </div>
                    </nav>
                </div>
                ...
                <div class="tab-content pb-4" id="nav-tabContent">
                    <!-- tab_1.案件統計 -->
                    <div id="tab_1" role="tabpanel" aria-labelledby="nav-tab_1" class="tab-pane bg-white fade p-2 rounded show active">
                        <div class="col-12">
                            <!-- Form Head：H -->
                            <div class="row">
                    ...
                    <!-- tab_2.訪談內容統計 -->
                    <div id="tab_2" role="tabpanel" aria-labelledby="nav-tab_2" class="tab-pane bg-white fade p-2 rounded">
                    ...
                    <!--3.安全存量警示清單 -->
                    <div id="tab_3" role="tabpanel" aria-labelledby="nav-tab_3" class="tab-pane bg-white fade p-2 rounded">
                    </div>
                </div>
