...
<div class="modal fade" id="edit_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" aria-modal="true" role="dialog" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="" method="post" onsubmit="this.formcase_dcc_no.disabled=false,this.dcc_no.disabled=false" >
                        ...
                        <div class="col-12 py-1">
                            <div class="col-12 border rounded">
                                ...
                                <div class="input-group">
                                    <input type="file" id="dcc_no" class="form-control mb-0" accept=".json" placeholder="上傳檔案">
