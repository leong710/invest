<?php
    ...
    if(!empty($uuid) && !isset($_REQUEST["submit"])){
        ...
        $document_row = array( 
                ...
                "row_confirm_sign" => (isset($_REQUEST["row_confirm_sign"]) ? $_REQUEST["row_confirm_sign"] : "")
        );
    }
    ...
    $pdf_json = array(
        ...
        "row_confirm_sign" => (isset($document_row["row_confirm_sign"]) ? $document_row["row_confirm_sign"]       : "")
    );
            ...
            <div class="row justify-content-center bg-light rounded py-4 px-2 m-2">
                ...
                <div class="col-12 text-end">
                    <snap id="submit_action">
                        ...
                        <input type="hidden" name="row_confirm_sign"   id="row_confirm_sign"  value="<?php echo $pdf_json["confirm_sign"];?>"  readonly>
                        <?php if($sys_role <= 2){ ?>
                ...
                <div class="col-6 col-md-6 py-0 px-2">
                    <div class="col-12 bg-white border rounded text-center">
                        ...
                        <!-- cow -->
                        <input type="text" name="confirm_sign" id="confirm_sign" class="form-control my-3" readonly required style="font-size: 12px;">
                        <!-- upload utility -->
