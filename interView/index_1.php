    ...
    <div class="col-12">
        <div class="row justify-content-center">
            <div class="col-mm-10 col-12 border rounded bg-white p-4 ">
                <div class="row">
                    <div class="col-12 col-md-3 px-3 py-0" id="btn_list">
                        <!-- append button here -->
                    </div>

                    <div class="col-12 col-md-9 bg-light border rounded px-3 py-5">
                        
                    </div>

                    <hr>
                    <div class="col-12 text-center">
                        <button type="button" id="service_window_btn" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#service_window">
                            <i class="fa-solid fa-circle-info"></i> 各廠聯絡窗口</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    function make_btn(value_1){
        if(value_1.dcc_no){
            let int_b = "<button type='button' class='btn btn-outline-primary add_btn form_btn' value='form.php?dcc_no="+ value_1.dcc_no +"' onclick='openUrl(this.value)' >"
                + "<div class='row p-2'><div class='col-12 col-md-4 icon'>" + icon_s + value_1._icon + icon_e + "</div>"
                + "<div class='col-12 col-md-8 py-0 px-1'><span style='font-size:12px;'>" + value_1.dcc_no + "</span></br>" + value_1.title + "</br><h5 class='mb-0'><b>- " + value_1.short_name +" -</b><h5></div></div></button>";
            return int_b;
        }else{
